<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/Applications/XAMPP/xamppfiles/htdocs/jbhad/addons/example/view/index/index.html";i:1524281068;s:83:"/Applications/XAMPP/xamppfiles/htdocs/jbhad/addons/example/view/layout/default.html";i:1524281068;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <head>
        ...
        <!-- Custom CSS -->
        <link href="/jbhad/public/assets/addons/example/css/common.css" rel="stylesheet">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <a href="https://www.fastadmin.net/store/cms.html" target="_blank">
                <div class="fill" style="background-image:url('https://cdn.fastadmin.net/uploads/banner/9.jpg');"></div>
                <div class="carousel-body">
                    <div class="container">
                        <h1 class="display-1 text-white">CMS插件</h1>
                        <h2 class="display-4 text-white">内容管理系统，可自定义内容模型、拥有标签、伪静态、区块等功能。</h2>
                    </div>
                </div>
            </a>
        </div>
        <div class="item">
            <a href="https://www.fastadmin.net/store/blog.html" target="_blank">
                <div class="fill" style="background-image:url('https://cdn.fastadmin.net/uploads/banner/7.jpg');"></div>
                <div class="carousel-body">
                    <div class="container">
                        <h1 class="display-1 text-white">简单博客</h1>
                        <h2 class="display-4 text-white">响应式博客插件，包含日志、评论、分类、归档，包含完善的后台管理和前台功能</h2>
                    </div>
                </div>
            </a>
        </div>
        <div class="item">
            <a href="https://www.fastadmin.net/store/docs.html" target="_blank">
                <div class="fill" style="background-image:url('https://cdn.fastadmin.net/uploads/banner/6.jpg');"></div>
                <div class="carousel-body">
                    <div class="container">
