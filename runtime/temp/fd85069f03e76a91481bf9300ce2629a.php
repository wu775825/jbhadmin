<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:93:"/Applications/XAMPP/xamppfiles/htdocs/jbhad/public/../application/admin/view/index/index.html";i:1523974192;s:83:"/Applications/XAMPP/xamppfiles/htdocs/jbhad/application/admin/view/common/meta.html";i:1523974192;s:85:"/Applications/XAMPP/xamppfiles/htdocs/jbhad/application/admin/view/common/header.html";i:1523974192;s:83:"/Applications/XAMPP/xamppfiles/htdocs/jbhad/application/admin/view/common/menu.html";i:1523974192;s:86:"/Applications/XAMPP/xamppfiles/htdocs/jbhad/application/admin/view/common/control.html";i:1523974192;s:85:"/Applications/XAMPP/xamppfiles/htdocs/jbhad/application/admin/view/common/script.html";i:1523974192;}*/ ?>
<!DOCTYPE html>
...
<nav class="navbar navbar-static-top">
    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <li>
                <a href="/jbhad/public/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
            </li>
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="/jbhad/public<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                    <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                </a>
                <ul class="dropdown-menu">
                    <!-- User image -->
                    <li class="user-header">
                        <img src="/jbhad/public<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="/jbhad/public<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
