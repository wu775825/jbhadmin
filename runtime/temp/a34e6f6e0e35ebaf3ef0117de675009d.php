<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/Applications/XAMPP/xamppfiles/htdocs/jbhad/addons/adminlte/view/index/index.html";i:1524368226;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <section class="">
                            ...
                            <div class="box-body">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <!-- /.direct-chat-info -->
                                        <img class="direct-chat-img" src="/jbhad/public/assets/img/avatar.png" alt="Message User Image"><!-- /.direct-chat-img -->
                                ...
                                <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="/jbhad/public/assets/img/avatar.png" alt="User Image">
                ...
                <div class="row">
                        ...
                        <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header bg-yellow">
                                <div class="widget-user-image">
                                    <img class="img-circle" src="/jbhad/public/assets/img/avatar.png" alt="User Avatar">
                                </div>
                                <!-- /.widget-user-image -->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="box box-widget widget-user">
                            <!-- Add the bg color to the header using any of the bg-* classes -->
                            <div class="widget-user-header bg-black" style="background: url('/jbhad/public/assets/img/qrcode.png') center center;">
                        ...
                        <div class="box box-widget">
                            <div class="box-header with-border">
                                <div class="user-block">
                                    <img class="img-circle" src="/jbhad/public/assets/img/avatar.png" alt="User Image">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                <img class="img-responsive pad" src="/jbhad/public/assets/img/qrcode.png" alt="Photo">
                            ...
                            <div class="box-footer box-comments">
                                <div class="box-comment">
                                    <!-- User image -->
                                    <img class="img-circle img-sm" src="/jbhad/public/assets/img/avatar.png" alt="User Image">
                            ...
                            <div class="box-footer">
                                <form action="#" method="post">
                                    <img class="img-responsive img-circle img-sm" src="/jbhad/public/assets/img/avatar.png" alt="Alt Text">
                        ...
                        <div class="box box-widget">
                            ...
                            <div class="box-body">
                                ...
                                <div class="attachment-block clearfix">
                                    <img class="attachment-img" src="/jbhad/public/assets/img/qrcode.png" alt="Attachment Image">
